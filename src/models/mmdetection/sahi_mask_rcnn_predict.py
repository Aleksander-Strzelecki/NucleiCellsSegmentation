...
OUTPUT_PATH = "../../../data/processed/mask_rcnn/trash"
VISUAL_OUTPUT_PATH = "../../../data/processed/mask_rcnn/trash2"
ID_TO_CLASS = {0: "Epithelial", 1: "Lymphocyte", 2: "Macrophage", 3: "Neutrophil"}

model_path = "../../../histopathology_app/models/weights/mask_rcnn.pth"
config_path = "./mask-rcnn_r50-caffe_fpn_ms-poly-3x_monusac.py"
