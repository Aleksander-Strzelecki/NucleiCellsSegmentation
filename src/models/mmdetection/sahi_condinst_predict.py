...
OUTPUT_PATH = "../../../data/processed/condinst/trash"
VISUAL_OUTPUT_PATH = "../../../data/processed/condinst/trash2"
ID_TO_CLASS = {0: "Epithelial", 1: "Lymphocyte", 2: "Macrophage", 3: "Neutrophil"}

model_path = "../../../histopathology_app/models/weights/condinst.pth"
config_path = "./condinst_r50_fpn_ms-poly-90k_monusac_instance.py"
