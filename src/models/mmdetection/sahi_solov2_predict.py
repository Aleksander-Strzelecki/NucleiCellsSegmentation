...
OUTPUT_PATH = "../../../data/processed/solov2/trash"
VISUAL_OUTPUT_PATH = "../../../data/processed/solov2/trash2"
ID_TO_CLASS = {0: "Epithelial", 1: "Lymphocyte", 2: "Macrophage", 3: "Neutrophil"}

model_path = "../../../histopathology_app/models/weights/solov2.pth"
config_path = "./solov2_r50-1x_monusac.py"
