...
model = dict(
    ...
    type='MaskRCNN')
optim_wrapper = dict(
    optimizer=dict(lr=0.0003, type='Adam', weight_decay=0.0001),
    type='OptimWrapper')
param_scheduler = [
    dict(
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(
            group='maskrcnn-r50-fpn-3x-monusac-adam', project='magisterka'),
...
work_dir = './work_dirs/mask-rcnn_r50-caffe_fpn_ms-poly-3x_monusac'
